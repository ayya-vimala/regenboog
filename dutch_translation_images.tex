...
\setmainfont[Numbers=OldStyle]{Alegreya Sans}
...
\begin{figure}[h]
    \centering
    \makebox[0pt]{%
    \includegraphics[width=0.9\paperwidth]{2-3.png}}
\end{figure}
...
\begin{figure}[h]
    \centering
    \makebox[0pt]{%
    \includegraphics[width=0.9\paperwidth]{6-7.png}}
\end{figure}
...
\begin{figure}[h]
    \makebox[280pt]{%
    \includegraphics[width=0.9\paperwidth]{4.png}}
\end{figure}
...
%\section*{\textit{Zolang individuën of boeddhistische organisaties zich schuldig maken aan homofobie, bifobie, transfobie of interfobie, houden zij haat, geweld en misbruik in stand.}}
...
\addcontentsline{toc}{section}{Boeddhisme heeft een LGBTQIA+-gechiedenis (en toekomst)}
...
\begin{figure}
    \centering
    \makebox[0pt]{%
    \includegraphics[width=0.9\paperwidth]{14.png}}
\end{figure}
...
\begin{figure}[h]
    \centering
    \makebox[0pt]{%
    \includegraphics[width=0.9\paperwidth]{18-19.png}}
\end{figure}
...
\begin{figure}[h]
    \centering
    \makebox[0pt]{%
    \includegraphics[width=0.7\paperwidth]{20.png}}
\end{figure}
...
“Juist spreken” is een belangrijk boeddhistisch concept. Onze woorden hebben consequenties. Vriendelijke woorden veroorzaken geen schade en daarmee tonen we respect. Woorden kunnen mensen ook kwetsen en het gevoel geven niet welkom te zijn. Respectloos taalgebruik, flauwe grappen en indringende vragen stroken niet met juist spreken en kunnen het moeilijk maken voor LGBTQIA+’ers om een onderdeel te zijn van boeddhistische organisaties.
	Hier onder lees je wat belangrijke tips bij het spreken met en over LGBTQIA+’ers. %reformat add tab
...
\begin{figure}[h]
    \centering
    \makebox[0pt]{%
    \includegraphics[width=0.6\paperwidth]{24.png}}
\end{figure}
...
\begin{figure}[h]
    \centering
    \makebox[0pt]{%
    \includegraphics[width=0.9\paperwidth]{26.png}}
\end{figure}
...
\begin{figure}[h]
    \centering
    \makebox[0pt]{%
    \includegraphics[width=0.9\paperwidth]{27.png}}
\end{figure}
...
\begin{figure}[h]
    \centering
    \makebox[0pt]{%
    \includegraphics[width=0.7\paperwidth]{29.png}}
\end{figure}
...
\begin{figure}[h]
    \centering
    \makebox[0pt]{%
    \includegraphics[width=0.8\paperwidth]{30.png}}
\end{figure}
...
\item 11 countries geven de doodstraf voor consensuele seks met hetzelfde geslacht.
\item 15 countries zien gender identiteit van transgender mensen als een misdaad, onder wetten over ‘travestie’, ‘imitatie’ en ‘vermomming’.
