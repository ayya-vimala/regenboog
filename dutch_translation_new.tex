...
\begin{figure}[h]
    \centering
    \makebox[0pt]{%
    \includegraphics[width=0.6\paperwidth]{22bw2.png}}
\end{figure}

\begin{quote}
\centering
\textit{\Large De opvattingen van mensen kunnen leiden tot vooroordelen en onverdraagzaamheid, discriminatie en onderdrukking, alsmede haat en geweld tegen LGBTQIA+ gemeenschappen.}
\end{quote}
