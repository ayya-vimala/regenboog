...
\usepackage[unicode, hidelinks, pdfauthor={Rainbodhi}, pdftitle={Verwelkom de regenboog}, pdfsubject={Boeddhisme}, pdfkeywords={Boeddhisme, LGBTIQA+, queer, transgender, lesbian, gay, bisexual, intersex, discrimination}, pdfproducer={LuaTeX  beta-0.70.1}, pdfcreator={LaTeX2e}]{hyperref}
...
\vfill
\thispagestyle{empty}
{\huge \textit{Verwelkom de regenboog} 
...
\textit{\large Moge iedereen gelukkig zijn}
...
%\section*{\textit{Zolang individuen of boeddhistische organisaties zich schuldig maken aan homofobie, bifobie, transfobie of interfobie, houden zij haat, geweld en misbruik in stand.}}

%\section*{\textit{Als we inzicht krijgen in hoe er meer gastvrijheid en inclusiviteit kan zijn voor LGBTQIA+’ers, kunnen we echt liefdevolle vriendelijkheid beoefenen naar iedereen in onze gemeenschappen.}}
...
Het is goed om te beseffen dat er LGBTQIA+’ers in boeddhistische gemeenschappen zijn. Je kunt er nooit vanuit gaan dat iedereen hetero is, of dat we door naar iemand te kijken meteen weten van welk geslacht/gender iemand is of welke voornaamwoorden gepast zijn. Erkennen dat ook LGBTQIA+’ers onze tempels, retraites en centra bezoeken is de eerste stap om meer inclusief te zijn.
...
\begin{quote}
\textit{Hetzij boeddhistische individuen en organisaties actief inclusief zijn, zullen LGBTQIA+’ers nog steeds uitgesloten worden.}
\end{quote}
...
\noindent\fbox{%
    \parbox{\textwidth}{%
\textbf{‘Zij/hun/(van) hen’ voornaamwoorden}
...
\noindent\fbox{%
   \parbox{\textwidth}{%
\textbf{Discriminatie van LGBTQIA+’ers} 
...
\noindent\fbox{%
    \parbox{\textwidth}{%
\textbf{Houdingen die kwetsend zijn voor intersekse mensen}
...
\item Onjuiste en verouderde taal, zoals ‘hermafrodiet’. Dit is misleidend en minachtend. Een intersekse variatie onterecht een ‘afwijking’ noemen, wat het niet is. 
\end{itemize}
    }%
}
...
Gender en seksualiteit zijn twee verschillende dingen. Gender is hoe we ons tot onszelf verhouden. Dit kan mannelijk zijn of vrouwelijk of nog iets anders. Seksualiteit is tot wie we ons aangetrokken voelen. Een cisgender persoon kan ook homo, hetero, biseksueel of aseksueel zijn. Een trans persoon kan ook hetero, biseksueel, aseksueel, homo of een andere seksualiteit hebben.   

\noindent\fbox{%
    \parbox{\textwidth}{%
\textbf{Houdingen die trans en non-binaire mensen kwetsen}

\medskip

Cisseksisme/cisgenderisme is een discriminerende sociale mening die claimt dat de transgender ervaring niet bestaat. Deze pijnlijke opvatting houdt in dat alleen binaire identiteiten (mannelijk of vrouwelijk) waardevol of echt zijn en dat genderidentiteit vastligt bij geboorte en uitsluitend gebaseerd is op geslachtskenmerken. 
...
\noindent\fbox{%
    \parbox{\textwidth}{%
\textbf{Houdingen die schade aanrichten aan mensen die op hetzelfde gender vallen}

\medskip

Bifobie: Een schadelijke houding ten opzichte van iemand die zich aangetrokken voelt tot meer dan een gender. Dit kan inhouden dat iemand wordt verteld dat hun seksualiteit ‘slechts een fase is’ of aangezet wordt om ‘een kant te kiezen’. Door een biseksueel als homo of hetero te bestempelen wanneer ze een bepaalde relatie hebben wist dat hun ware identiteit uit.   

Heteronormativiteit: De opvatting dat een heteroseksuele relatie de enige natuurlijke, normale en legitieme uiting van seksualiteit is en dat andere seksualiteiten of genderidentiteiten onnatuurlijk zijn en een bedreiging vormen voor de samenleving.   

Homofobie: Negatieve overtuigingen, vooroordelen en stereotypen over niet-heteroseksuele mensen. Verbale homofobie is een veelvoorkomende vorm, inclusief schelden, roddelen en beledigende woorden (‘flikker’ of ‘pot’) of ziennen als ‘dat is zo gay’.
Bij homofobie horen ook beledigende bedreigingen, fysiek geweld, seksuele intimidatie, discriminerende wetgeving enhet opzettelijk uitsluiten van iemand vanwege hun seksualiteit. 
    }%
}
