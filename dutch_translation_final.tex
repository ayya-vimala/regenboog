...
\begin{figure}[h]
    \centering
    \makebox[0pt]{%
    \includegraphics[width=0.5\paperwidth]{22bw2.png}}
\end{figure}
...
Misgenderen is het beschrijven of aanspreken van een persoon met behulp van woorden die niet overeenkomen met hun genderidentiteit. Dit gaat over onjuist gebruik van voornaamwoorden (zij, hij, hun), familietitels (vader, zus, oom) en andere woorden die van oudsher gegenderd worden gebruikt, zoals stoer, schattig, enzovoort. 
